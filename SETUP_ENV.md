...
**Example** (with placeholder values - NEVER use real keys here):
```bash
NEXT_PUBLIC_SUPABASE_URL=https://your-project-ref.supabase.co
NEXT_PUBLIC_SUPABASE_ANON_KEY=your-anon-key-here
SUPABASE_SERVICE_ROLE_KEY=your-service-role-key-here
...
⚠️ **SECURITY WARNING:** Never commit real API keys to version control. Always use placeholders in documentation files.
